<?php
$page_title = $id > 0 ? 'Editar Imagen' : 'Agregar Imagen';
$unread_count = $unread_messages ?? 0;
ob_start();
?>
<div class="admin-card">
    <div class="card-header">
        <h2><?= $id > 0 ? 'Editar Imagen de la Galería' : 'Agregar Imagen a la Galería' ?></h2>
        <a href="/admin.php?route=gallery" class="btn btn-outline">Cancelar</a>
    </div>
    ...
    <form action="/admin.php?route=gallery&action=edit<?= $id > 0 ? '&id=' . $id : '' ?>" method="POST" enctype="multipart/form-data">
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="caption" name="caption" value="<?= htmlspecialchars($item['caption'] ?? '') ?>" placeholder="Ej. Niños felices recibiendo complementos alimenticios.">
            </div>
